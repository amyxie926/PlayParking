...
public class ResideMenu extends FrameLayout {
    ...
    private void showScrollViewMenu(LinearLayout scrollViewMenu) {
        if (scrollViewMenu != null && scrollViewMenu.getParent() == null) {
            addView(scrollViewMenu);
        }
    }

    private void hideScrollViewMenu(LinearLayout scrollViewMenu) {
        if (scrollViewMenu != null && scrollViewMenu.getParent() != null) {
